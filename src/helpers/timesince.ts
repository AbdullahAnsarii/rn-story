export function timeSince(timeStamp: any) {
    ...
    var formatDate = function (date?: any, format?: any, utc?: any) {
        var MMMM:any = ["\x00", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
        var MMM:any = ["\x01", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
        var dddd:any = ["\x02", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
        var ddd:any = ["\x03", "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
    ...
    if (secondsPast < 60) { // Less than a minute
        return parseInt(secondsPast.toString()).toFixed(0) + 'secs';
    }
    if (secondsPast < 3600) { // Less than an hour
        return (parseInt(secondsPast.toString()) / 60).toFixed(0) + 'mins';
    }
    if (secondsPast <= 86400) { // Less than a day
        return (parseInt(secondsPast.toString()) / 3600).toFixed(0) + 'hrs';
    }
